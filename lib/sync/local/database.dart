...
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
        onUpgrade: (m, from, to) async {
          ...
          if (from < 10) {
            await m.addColumn(sessions, sessions.repTraceJson);
            await m.addColumn(sessions, sessions.integrityVerdict);
            await m.addColumn(sessions, sessions.rejectedReason);
          }
        },
      );
